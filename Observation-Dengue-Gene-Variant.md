# Dengue Virus Genetic Variant Example - FHIR Implementation Guide Genomics Reporting (Draft) v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Dengue Virus Genetic Variant Example**

## Example Observation: Dengue Virus Genetic Variant Example
...
> **component****code**: Genomic DNA change (gHGVS)**value**: NC_001475.2:g.198A>G

> **component****code**: NC_000962.3**value**: Dengue virus 3, complete genome

> **component****code**: Allelic read depth**value**: 300 reads per base pair (Details: UCUM code[1] = '[1]')
        ...
        "coding" : [
          {
            ...
            "code" : "NC_001475.2:g.198A>G",
            "display" : "NC_001475.2:g.198A>G"
          }
        ]
      }
    },
        ...
        "coding" : [
          {
            "system" : "http://www.ncbi.nlm.nih.gov/refseq",
            "code" : "NC_001475.2",
            "display" : "Dengue virus 3, complete genome"
          }
        ]
      }
    },
