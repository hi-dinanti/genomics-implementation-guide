...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition">
      <sch:assert test="count(f:extension[@url = 'https://fhir.kemkes.go.id/r4/StructureDefinition/DocumentStatus']) &gt;= 1">extension with URL = 'https://fhir.kemkes.go.id/r4/StructureDefinition/DocumentStatus': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.kemkes.go.id/r4/StructureDefinition/DocumentStatus']) &lt;= 1">extension with URL = 'https://fhir.kemkes.go.id/r4/StructureDefinition/DocumentStatus': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Composition/f:section/f:orderedBy</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Composition/f:section/f:emptyReason</sch:title>
