...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'recipient']) &lt;= 1">extension with URL = 'recipient': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'request']) &lt;= 1">extension with URL = 'request': maximum cardinality of 'extension' is 1</sch:assert>
